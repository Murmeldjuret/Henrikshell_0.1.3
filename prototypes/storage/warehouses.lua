...
--Basic warehouse--
	...
	},
	{
		...
		collision_box = {{-1.8, -1.8}, {1.8, 1.8}}, -- {{-2.2, -2.2}, {2.2, 2.2}},
		selection_box = {{-2.0, -2.0}, {2.0, 2.0}}, -- {{-2.5, -2.5}, {2.5, 2.5}},
		fast_replaceable_group = "container",
		inventory_size = 200,
	
		picture =
		{
			filename = "__Henrikshell__/graphics/entity/storage/warehouse-small.png",
			priority = "high",
			width = 173,
			height = 160,
			shift = {0.6, -0.2},
